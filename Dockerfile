...
RUN pip install --upgrade pip && pip install setuptools psycopg2-binary sqlalchemy pyhive elasticsearch-dbapi ibm_db_sa jupyter pandas numpy sklearn scipy s3 graphviz jupyter_http_over_ws dask modin pyarrow
